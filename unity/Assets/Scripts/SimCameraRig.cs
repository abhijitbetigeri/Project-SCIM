        ...
        public void Focus(Preset p)
        {
            ...
            switch (p)
            {
                case Preset.Branches:
                    // High and back, so all three branches read at once.
                    _targetPos = new Vector3(0f, 34f, -30f);
                    _targetRot = Quaternion.Euler(42f, 0f, 0f);
                    break;

                case Preset.Warehouse:
                    _targetPos = MiseScenario.WarehouseOrigin + new Vector3(0f, 18f, -22f);
                    _targetRot = Quaternion.Euler(34f, 0f, 0f);
                    break;
